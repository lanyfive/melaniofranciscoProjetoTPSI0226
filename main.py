...
# =========================================
    def show_dashboard(self):
        ...
        label = tk.Label(self.main_content, text="SISTEMA DE GESTÃO DE ALUGUER DE CARROS", font=("Arial", 22), bg="#F4F6FA", fg="#2c3e50")
        label.pack(pady=40)
...
# =========================================
    def show_customers(self):
        ...
        # ÁREA DE CONTEÚDO
        self.customers_content = tk.Frame(self.main_content, bg="white")
        ...
        # BOTÕES SIDEBAR
        btn_insert = tk.Button(sidebar, text="Inserir", width=20, command=self.show_insert_customer)
        btn_insert.pack(pady=5)
        btn_update = tk.Button(sidebar, text="Atualizar", width=20, command=self.show_update_customer)
        btn_update.pack(pady=5)
        btn_delete = tk.Button(sidebar, text="Apagar", width=20)
        btn_delete.pack(pady=5)
        btn_list = tk.Button(sidebar, text="Listar", width=20)
    ...
    def show_insert_customer(self):
        ...
        titulo = tk.Label(self.customers_content, text="Inserir Cliente", font=("Arial", 20, "bold"), bg="white")
        titulo.pack(pady=20)

        form = tk.Frame(self.customers_content, bg="white")
        form.pack(pady=20)

        tk.Label(form, text="Nome:", bg="white", font=("Arial", 12)).grid(row=0, column=0, pady=10, sticky="w")
        entry_nome = tk.Entry(form, width=35)
        entry_nome.grid(row=0, column=1, pady=10)
        tk.Label(form,text="Login:",bg="white",font=("Arial", 12)).grid(row=1, column=0, pady=10, sticky="w")
        entry_login = tk.Entry(form, width=35)
        entry_login.grid(row=1, column=1, pady=10)
        tk.Label(form, text="Role:", bg="white", font=("Arial", 12)).grid(row=2, column=0, pady=10, sticky="w")
    ...
    def show_update_customer(self):
        ...
        titulo = tk.Label(self.customers_content,text="Atualizar Cliente",font=("Arial", 20, "bold"),bg="white")
        titulo.pack(pady=20)
...
# =========================================
    def show_users(self):
        ...
        # ÁREA DE CONTEÚDO
        self.users_content = tk.Frame(self.main_content, bg="white")
        ...
        # BOTÕES SIDEBAR
        btn_insert = tk.Button(sidebar, text="Inserir", width=20, command=self.show_insert_user)
        btn_insert.pack(pady=5)
        btn_update = tk.Button(sidebar, text="Atualizar", width=20, command=self.show_update_user)
        btn_update.pack(pady=5)
        btn_delete = tk.Button(sidebar, text="Apagar", width=20)
        btn_delete.pack(pady=5)
        btn_list = tk.Button(sidebar, text="Listar", width=20)
    ...
    def show_insert_user(self):
        ...
        titulo = tk.Label(self.users_content, text="Inserir Utilizador", font=("Arial", 20, "bold"), bg="white")
        titulo.pack(pady=20)
    ...
    def show_update_user(self):
        ...
        titulo = tk.Label(self.users_content,text="Atualizar Utilizador",font=("Arial", 20, "bold"),bg="white")
        titulo.pack(pady=20)
